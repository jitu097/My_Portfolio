...
import FaceInsight from "../../assets/FaceInsight.png";
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              <svg width="50" xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24" fill="none" stroke="#23ce6b" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"> <title>Folder</title> <path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"></path> </svg>
              <div className="project-links">
                <a href="https://github.com/jitu097/FaceInsight" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" /></a>
                <a href="https://face-insight.vercel.app/" target="_blank" rel="noreferrer">
                  <img src={externalLink} alt="Visit site" /></a>
              </div>
            </header>
            <div className="body">
              <h3>FaceInsight</h3>
              <div className="project-image-container">
                <img src={FaceInsight} alt="Project Preview" className="project-image"/>
                <div className="image-overlay">
                  <p>
                  FaceInsight is a project that uses AI to detect faces, analyze key landmarks, estimate age, and interpret facial expressions.</p>
                </div>
              </div>
            </div>
            <footer>
